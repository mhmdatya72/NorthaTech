...
const features = [
    {
        ...
        description: 'إنشاء وإدارة الفواتير بشكل احترافي مع إمكانية التخصيص الكامل',
    ...
    },
    {
        ...
        description: 'تتبع المصروفات وإدارة الميزانية بشكل فعال مع تقارير تفصيلية',
    ...
    },
    {
        ...
        description: 'تقارير مالية متكاملة مع إمكانية التخصيص والتحليل المتقدم',
                    ...
                    <Grid item xs={12} md={6}>
                        <AnimatedSection direction="right">
                            ...
                            <Typography variant="h5" color="text.secondary" paragraph>
                                نظام محاسبة متكامل للشركات
                            </Typography>
                            <Typography variant="body1" paragraph>
                                زوهو Books هو نظام محاسبة متكامل يساعد الشركات على إدارة عملياتها المالية بشكل فعال. يوفر النظام مجموعة شاملة من الأدوات لإدارة الفواتير والمصروفات والتقارير المالية.
                            </Typography>
                        </AnimatedSection>
                    </Grid>
                    <Grid item xs={12} md={6}>
